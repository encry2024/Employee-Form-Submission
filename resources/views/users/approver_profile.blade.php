                ...
                <div class="row">
                    <nav class="col-lg-2 col-md-3 col-sm-3 col-xs-12 sidebar">
                        <ul class="nav nav-pills nav-stacked col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('edit_user', $user->id) }}"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;&nbsp; Deactivate User</a></li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-12">
                                            <div class="panel panel-default">
                                                <div class="panel-heading" style="background-color: white;">
                                                    <h2 class="panel-title">
                                                        <span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;&nbsp;Forms Submitted
                                                    </h2>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="btn-group col-lg-12" role="group" aria-label="...">
                                                        <button class="btn btn-primary" type="button">Change Schedule&nbsp;&nbsp;&nbsp;<span class="badge">5</span></button>
                                                        <button class="btn btn-success" type="submit">Overtime&nbsp;&nbsp;&nbsp;<span class="badge">5</span></button>
                                                        <button class="btn btn-danger" type="submit">Leave&nbsp;&nbsp;&nbsp;<span class="badge">{{ $getSubmittedLeaveCount->count() }}</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputRole" class="col-sm-4 control-label">User Role</label>
                                                            <div class="col-sm-8">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <form class="form-horizontal">
                                                        <div class="form-group">
                                                            <label for="inputLeaveSettings" class="col-sm-4 control-label">Vacation Leave</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputSickLeave" class="col-sm-4 control-label">Sick Leave</label>
                                                            <div class="col-sm-8">

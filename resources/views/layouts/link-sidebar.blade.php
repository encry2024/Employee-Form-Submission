<nav class="col-lg-2 col-md-3 col-sm-3 col-xs-12 sidebar" style="background-color: #0091b7;">
    <ul class="nav nav-pills nav-stacked col-lg-12 col-md-12 col-sm-12 col-xs-12" style="font-weight: 100px; font-size: 17px;">
        ...
        <li class="nav-item {{ Request::route()->getName() == 'campaigns' ? 'active' : '' }}"><a class="nav-link" href="{{ route('campaigns') }}"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;&nbsp; Campaigns <span class="badge pull-right" style="font-size: 17px;">{{ count($campaigns) }}</span></a></li>
    </ul>
</nav>